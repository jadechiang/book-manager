            ...
            if (!this.grid) {
                ...
                M = function(a, b, c, e) {
                    ...
                    if (a) { - 1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b: 1 : (H.call(d, !1, !0), b = 1);
                        ...
                        for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                            ...
                            var fa = Q.length;
                            for (Q.push(""), M && Q.push(E(0, o, d.p.page, d.p.rowNum, ca)), J && Q.push(D(x, M, o, U, da)), L && Q.push(r.call(A, J + M, o + b)), s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++) m = $.jgrid.getAccessor(q, s[p]),
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var e = d.p.beforeSelectRow.call(d, ga[0].id, a); (e === !1 || "stop" === e) && (c = !1)
                    }
        ...
        createEl: function(b, c, d, e, f) {
            ...
            case "select":
                ...
                if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                    ...
                    a.ajax(a.extend({
                        url: a.isFunction(c.dataUrl) ? context+c.dataUrl.call(i, n, d, String(c.name)) : context+c.dataUrl,
                        type: "POST",
                        dataType: "html",
        ...
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                    ...
                    a(A).find(".FormElement").each(function() {
                        ...
                        if (c.length) {
                            ...
                            case "select-multiple":
                                ...
                                u[this.name] ? u[this.name] = u[this.name].join(",") : u[this.name] = "";
                                var h = [];
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                        if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'": "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                            ...
                            if ("_empty" === c && u.defaultValue && (k = a.isFunction(u.defaultValue) ? u.defaultValue.call(s) : u.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, u, k, !1, a.extend({},
                            ...
                            "custom" === this.edittype && a.isFunction(u.custom_value) && u.custom_value.call(s, a("#" + h, y), "set", k),
                        ...
                        (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[d.p.id + "_id"] = c)
                    }
                    return p
                }
                function i(c, d, e) {
                    var f, g, h, i, j, k, l = 0; (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData = {},
                    ...
                    n && (a('td[role="gridcell"]', n).each(function(h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            case "checkbox":
                                ...
                                g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[s.p.useProp ? "prop": "attr"]("checked", !0), a("#" + f, e)[s.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + f, e)[s.p.useProp ? "prop": "attr"]("checked", !1), a("#" + f, e)[s.p.useProp ? "prop": "attr"]("defaultChecked", !1)); (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"), b[s.p.id]._savedData[f] = g);
                                break;
                            case "custom":
                                try {
                ...
                function k() {
                    ...
                    a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w), q && "object" == typeof q && (u = q));
                    for (g in u) if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), n[0] === !1)) break;
                    if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [b[s.p.id], u, w]), void 0 === o && a.isFunction(b[s.p.id].onclickSubmit) && (o = b[s.p.id].onclickSubmit.call(s, b[s.p.id], u, w) || {}), n = a(s).triggerHandler("jqGridAddEditBeforeSubmit", [u, a(y), w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].beforeSubmit) && (n = b[s.p.id].beforeSubmit.call(s, u, a(y), w))), n[0] && !b[s.p.id].processing) {
                        ...
                        var v = a.extend({
                            ...
                            complete: function(g, j) {
                                var l;
                                if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), n[0] === !1) a(".FormError", y).html(n[1]),
                                a(".FormError", y).show();
                                ...
                                500)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (a(y).data("disabled", !1), "_empty" !== b[s.p.id]._savedData[s.p.id + "_id"])) for (l in b[s.p.id]._savedData) b[s.p.id]._savedData.hasOwnProperty(l) && u[l] && (b[s.p.id]._savedData[l] = u[l]);
                        ...
                        if (v.url || b[s.p.id].useDataProxy || (a.isFunction(s.p.dataProxy) ? b[s.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + G.nourl)), n[0]) if (b[s.p.id].useDataProxy) {
                            ...
                            void 0 === z && (z = [!0, ""]),
                            z[0] === !1 ? (n[0] = !1, n[1] = z[1] || "Error deleting the selected row!") : (v.data.oper === p.addoper && b[s.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(x),
                                jqm: d.jqModal,
                                onClose: b[s.p.id].onClose,
                                removemodal: b[s.p.id].removemodal,
                ...
                function m() {
                    ...
                    e(), v = l(u, b[s.p.id]._savedData), v && (a(y).data("disabled", !0), a(".confirm", "#" + B.themodal).show(), c = !1)),
                    c
                }
                function n() {
                    var b;
                ...
                if (s.grid && c) {
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
                        ...
                        if (F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), W = a("<div id=" + z + "></div>").append(L)) : W = a("<div></div>").append(L).append(T), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>"), a.jgrid.createModal(B, W, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0]), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), W = null, T = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function(c) {
                            ...
                            if (b[s.p.id].savekey[0] === !0 && c.which === b[s.p.id].savekey[1] && "TEXTAREA" !== e.tagName) return a("#sData", A + "_2").trigger("click"),
                            !1;
                        ...
                        a("#sData", t).click(function() {
                            ...
                            a(".FormError", y).hide(),
                            e(),
                            "_empty" === u[s.p.id + "_id"] ? k() : d.checkOnSubmit === !0 ? (v = l(u, b[s.p.id]._savedData), v ? (a(y).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(B.themodal)).show()) : k()) : k(),
                            !1
                        }),
                        ...
                        a("#nData", t).click(function() {
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a(y), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "next", a(y), b[1][b[0] + 1]),
                                r(),
                                o(b[0] + 1, b)
                            }
                            return ! 1
                        ...
                        a("#pData", t).click(function() {
                            ...
                            if ( - 1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                i(b[1][b[0] - 1], s, y),
                                a(s).jqGrid("setSelection", b[1][b[0] - 1]),
                                a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a(y), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "prev", a(y), b[1][b[0] - 1]),
                                r(),
                                o(b[0] - 1, b)
                            }
                            return ! 1
                            ...
                            a.isFunction(b[e.p.id].onclickSubmit) && (p = b[e.p.id].onclickSubmit.call(e, b[e.p.id], l) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, l)), g[0] && !b[e.p.id].processing) {
                                ...
                                var m = a.extend({
                                    ...
                                    complete: function(c, i) {
                                        var j;
                                        if (a("#dData", "#" + r + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, a.isFunction(b[e.p.id].errorTextFormat) ? g[1] = b[e.p.id].errorTextFormat.call(e, c) : g[1] = i + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f)), g[0] === !1) a("#DelError>td", "#" + r).html(g[1]),
                                        a("#DelError", "#" + r).show();
                                        else {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        ...
                        a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            a("select", g).bind("change", function(d) {
                            	a(i).jqGrid("saveCell", b, c),
								d.stopPropagation()
							}),
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            v = !1;
                            if (u[0] === !0) {
                                var w = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, l, h, b, c]) || {};
                                if (a.isFunction(e.p.beforeSubmitCell) && (w = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), w || (w = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit) if (e.p.cellurl) {
                                    ...
                                    k.editoptions && k.editoptions.NullIfEmpty && "" === h && (h = "null", v = !0),
                                    x[l] = h;
                                    var y, z, A;
                                    A = e.p.prmNames,
                                    y = A.id,
        ...
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                s = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common; c > b;) {
                    ...
                    void 0 !== k[r] && ("true" === k[r] || k[r] === !0 ? k[r] = !0 : k[r] = !1),
        ...
        getRootNodes: function(b) {
            ...
            return this.each(function() {
                ...
                case "adjacency":
                    ...
                    a(f).each(function() { (null === this[e] || "null" === String(this[e]).toLowerCase()) && (b ? c.push(g.p.data[g.p._index[this[g.p.keyName]]]) : c.push(this))
                    })
                }
            }),
            c
